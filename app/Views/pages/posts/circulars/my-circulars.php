	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				<div class="row">
					<div class="col-lg-5">
						<h4 class="header-title mt-2 mb-4">My circulars</h4>
					</div>
					<div class="col-lg-3">
						<form method="get">
					...
					<div class="col-lg-2">
						...
						<a href="<?=site_url('/circulars')?>" type="button" class="btn btn-primary btn-sm btn-block float-right">All Circulars</a>
                          ...
                          <span class="logo-lg">
                            <img src="../assets/images/logo-sm.png" alt="" height="50">
									...
									<div class="text-center mt-4">
										...
										<a href="<?=site_url('circulars'); ?>"  class="btn btn-success waves-effect waves-light">Back to Home</a>
									</div>
								</div> <!-- end card-body -->
							</div>
							<!-- end card -->
	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				<div class="row">
					<div class="col-lg-5">
						<h4 class="header-title mt-2 mb-4"> Circulars Signed/To be Signed By Me</h4>
					</div>
					<div class="col-lg-3">
						<form method="get">
							<div class="form-group">
				...
				<div class="row mt-2">
					...
					<?php else: ?>
						<?php foreach ($s_circulars as $circular): ?>
							<div class="col-lg-4" style="padding-bottom: 5px; max-height: 100%" >
								<div class="card-box project-box mb-n5" >
									<!-- Title-->
									<h4 class="mt-0"><a href="<?=site_url('view-circular')."/".$circular['p_id']; ?>" class="text-dark"><?=$circular['p_subject'] ?></a></h4>
